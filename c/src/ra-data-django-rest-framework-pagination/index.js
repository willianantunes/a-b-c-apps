...
import * as DjangoRestFrameworkPagination from './django-rest-framework-pagination'

export default (apiUrl, httpClient = fetchUtils.fetchJson) => ({
  getList: async (resource, params) => {
    console.debug('getList has been called. Params:', JSON.stringify(params))
    console.debug('getList has been called. Resource:', JSON.stringify(resource))
    const query = {
      ...DjangoRestFrameworkPagination.translateFilter(params.filter),
      ...DjangoRestFrameworkPagination.translatePaginationQuery(params.pagination),
      ...DjangoRestFrameworkPagination.translateSort(params.sort),
    }
    console.debug('Query built:', JSON.stringify(query))
  ...
  getManyReference: async (resource, params) => {
    ...
    // Translate the query parameters to the format DjangoRestFrameworkPagination expects
    const query = {
      ...DjangoRestFrameworkPagination.translateFilter(params.filter),
      ...DjangoRestFrameworkPagination.translatePaginationQuery(params.pagination),
      ...DjangoRestFrameworkPagination.translateSort(params.sort),
